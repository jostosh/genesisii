...
class RMSEveOptimizer(object):
    ...
    def __init__(self, lr=0.001, beta_1=0.9, beta_2=0.999, beta_3=0.999, epsilon=1e-8, decay=0.,
                 thl=0.2, thu=5., d_clip_lo=0.1, d_clip_hi=10.0, epsilon_feedback=1e-8):
    ...
    def get_updates(self, params, loss, constraints=[]):
        ...
        d_t = (self.beta_3 * self.d) + (1. - self.beta_3) * tf.abs((loss_hat - loss_hat_prev) /
                                                                   (d_den + self.epsilon_feedback))
